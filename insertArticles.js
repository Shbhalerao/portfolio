// Script to insert dummy Medium articles into the backend
// Usage: node insertArticles.js

const axios = require('axios');

const API_URL = 'http://localhost:5000/api/articles';
const ADMIN_TOKEN = 'PASTE_YOUR_ADMIN_JWT_TOKEN_HERE'; // Replace with your actual admin JWT token
